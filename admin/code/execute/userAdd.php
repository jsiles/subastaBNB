...
$usr_loginA = admin::toSql(safeHtml(admin::getParam("usr_login")),"Text");
$usr_passA = admin::toSql(safeHtml(admin::getParam("usr_pass")),"Text");
$usr_firstnameA = admin::toSql(safeHtml(admin::getParam("usr_firstname")),"Text");
$usr_lastnameA = admin::toSql(safeHtml(admin::getParam("usr_lastname")),"Text");
$usr_emailA = admin::toSql(safeHtml(admin::getParam("usr_email")),"Text");
$usr_photoA = admin::toSql(safeHtml(admin::getParam("usr_photo")),"Text");
$usr_statusA = admin::toSql(safeHtml(admin::getParam("usr_status")),"Text");
