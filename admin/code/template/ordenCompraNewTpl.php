...
<br>
<form name="addOC" method="post" action="code/execute/ordenCompraAdd.php" enctype="multipart/form-data">
...
<br />
      ...
      <div id="contentButton">
          ...
          <td width="41%" style="font-size:11px;">
		  		<?=admin::labels('or');?> <a href="ordenCompraList.php?$tipUid=<?=$tipUid?>" ><?=admin::labels('cancel');?></a> 
		  </td>
        </tr>
      </table></div>
      <br /><br />
